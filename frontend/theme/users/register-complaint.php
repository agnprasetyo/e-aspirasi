...
$query=mysqli_query("insert into tblcomplaints(userId,category,subcategory,complaintType,state,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$compfile')");
...
<html lang="en">
  <head>
    ...
    <title>E-Aspirasi | User Register Complaint</title>
...
<label class="col-sm-2 col-sm-2 control-label">Jenis Infrastruktur Public </label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Status Infrastruktur  </label>
 <div class="col-sm-4">
